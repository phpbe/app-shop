...
<be-page-content>
    ...
    <div id="app" v-cloak>
        ...
        ?>>
            ...
            if ($this->multiple) {
                $tableUi['@row-click'] = 'toggleRow';
                $tableUi['@selection-change'] = 'selectionChange';
            } else {
                $tableUi['highlight-current-row'] = 'true';
                $tableUi['@row-click'] = 'selectRow';
            }
                ...
                if ($this->multiple) {
                    ...
                    <el-table-column
                        ...
                        <template scope="scope">
                            <el-radio :label="scope.row.id" v-model="selectedValue" @change="selectRow">&nbsp</el-radio>
                        </template>
                    </el-table-column>
                    <?php
                }
            ...
            <div class="be-row be-mt-50">
                ...
                <div class="be-col-auto">
                    <el-button type="primary" icon="el-icon-check" @click="pickerConfirm" :disabled="selectedRows.length === 0">确定</el-button>
                </div>
            </div>
    ...
    <script>
        ...
        var vueGrid = new Vue({
            ...
            data: {
                ...
                excludeIds: <?php echo json_encode($this->excludeIds); ?>,
            ...
            methods: {
                ...
                checkSelectable: function (row) {
                    return this.excludeIds.indexOf(row.id) === -1;
                },
                ...
                toggleRow: function (row) {
                    if (this.excludeIds.indexOf(row.id) === -1) {
                ...
                pickerConfirm: function () {
                    <?php
                    if ($this->multiple) {
                        echo 'parent.'.$this->callback.'(this.selectedRows);';
                    } else {
                        echo 'parent.'.$this->callback.'(this.selectedRows[0]);';
                    }
                    ?>
                },
